        ...
        if let resultCell = cell {
            ...
            case 0:
                ...
                if model.subItem == "0" || model.subItem == "1" {
                    let onSwitch = HMSwitch.init(frame: CGRectMake(self.frame.width - 80, (CGRectGetHeight(resultCell.contentView.frame) - resultCell.contentView.frame.height * (1 / 2)) / 2, 70, resultCell.contentView.frame.height * (1 / 2)))
