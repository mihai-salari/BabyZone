...
@property (nonatomic, copy) void(^locationHandler)(NSString *place);
...
//        NSLog(@"国家：%@ 城市：%@ 州:%@ 其他行政区域:%@",placemark.country,placemark.locality,placemark.administrativeArea,placemark.subAdministrativeArea);
        NSString *resultPlace;
        if (placemark.subAdministrativeArea && ![placemark.subAdministrativeArea isEqualToString:@"(null)"]) {
            if (placemark.locality && ![placemark.locality isEqualToString:@"(null)"]) {
                resultPlace = [NSString stringWithFormat:@"%@ %@ %@",placemark.administrativeArea,placemark.locality,placemark.subAdministrativeArea];
            }else{
                resultPlace = [NSString stringWithFormat:@"%@ %@",placemark.subAdministrativeArea,placemark.subAdministrativeArea];
            }
        }else{
            if (placemark.locality && ![placemark.locality isEqualToString:@"(null)"]) {
                resultPlace = [NSString stringWithFormat:@"%@ %@",placemark.administrativeArea,placemark.locality];
            }else{
                resultPlace = [NSString stringWithFormat:@"%@",placemark.administrativeArea];
            }
            
        }
        if (_locationHandler) {
            _locationHandler(resultPlace);
        }
