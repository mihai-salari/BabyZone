...
@interface HMSliderView()
- (void) loadContent;
- (UIImage *) thumbWithColor:(UIColor*)color;
- (UIImage *) clearPixel;
@end

@implementation HMSliderView
...
- (void) loadContent {
    ...
    if (!_label || !_slider) {
        ...
        _label = [[HMSliderLabel alloc] initWithFrame:CGRectZero];
...
- (void)setThumbImage:(UIImage *)image{
    [_slider setThumbImage:[image imageByScalingAndCroppingForSize:CGSizeMake(20, 20)] forState:UIControlStateNormal];
}
