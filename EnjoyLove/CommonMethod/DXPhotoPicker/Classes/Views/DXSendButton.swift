...
class DXSendButton: UIView {
    ...
    struct DXSendButtonConfig {
        ...
        static let sendButtonFont = UIFont.systemFontOfSize(14.0)
    }
    ...
    override init(frame: CGRect) {
        ...
        self.frame = CGRectMake(0, 0, 56 * UIScreen.mainScreen().bounds.size.width / 320, 26)
        setupViews()
    }
    ...
    private lazy var sendButton: UIButton = {
        ...
        button.setTitle(DXlocalizedString("send", comment: "确定"), forState: UIControlState.Normal)
